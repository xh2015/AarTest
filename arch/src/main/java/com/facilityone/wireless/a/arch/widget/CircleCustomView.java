...
public class CircleCustomView extends View {
    ...
    public CircleCustomView(Context context, AttributeSet attrs, int defStyle) {
        ...
        downTvColor = mTypedArray.getColor(R.styleable.CircleProgressView_downTvColor, 0x999999);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setStrokeWidth(roundWidth - 6); //设置圆环的宽度
...
//        float percent = 0F;
//        if (max != 0) {
//            percent = ((float)progress / (float)max)*100;
//        }
...
//            String p = StringUtil.formatFloatCost(percent) + "%";
//            float textWidth1 = paint.measureText(p);
//            paint.setTextSize(textSize);
//            canvas.drawText(p, centre - textWidth1 / 2, centre + textSize / 8, paint);
//            float textWidth3 = paint.measureText(getResources().getString(R.string.complete_tip));
//            paint.setTextSize(downTvSize);
//            paint.setColor(downTvColor);
//            canvas.drawText(getResources().getString(R.string.work_order_percent),
