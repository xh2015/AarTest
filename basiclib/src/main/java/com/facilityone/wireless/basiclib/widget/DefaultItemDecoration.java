...
public class DefaultItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (columnCount == 1) {
            ...
            } else if (lastRaw && firstColumn) { // top, right bottom
                outRect.set(0, mDividerHeight / 2, mDividerWidth / 2, mDividerWidth);
            } else if (lastRaw && lastColumn) { // left, top bottom
                outRect.set(mDividerWidth / 2, mDividerHeight / 2, 0, mDividerWidth);
            } else if (lastRaw) { // left, top, right bottom
                outRect.set(mDividerWidth / 2, mDividerHeight / 2, mDividerWidth / 2, mDividerWidth);
